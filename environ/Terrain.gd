...
onready var season_tilemaps = {
	Enums.Season.WINTER: $Winter,
	Enums.Season.AUTUMN: $Autumn,
	Enums.Season.SUMMER: $Summer,
	Enums.Season.SPRING: $Spring,
}
...
func change_season(new_season=null):
	...
	move_child(tilemap_new_season, tilemaps.size()-2)
